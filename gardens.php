...
if (!$skipgardendesc) {
	...
	output("From the flowerbeds that bloom even in darkest winter, to the hedges whose shadows promise forbidden secrets, these gardens provide a refuge for those seeking out the Mythos Dragons; a place where they can forget their troubles for a while and just relax.`n`n");
