...
output("Seriously, though. The purpose is to slay the Mythos Dragons.`n`n");
output("`^2. How do I find the Mythos Dragons?`n");
output("`@You can't.`n");
output("Well, sort of.");
output("You can't find them until you've reached a certain level.");
